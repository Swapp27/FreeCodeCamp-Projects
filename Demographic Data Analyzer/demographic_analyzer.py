...
def calculate_demographic_data(print_data=True):
    ...
    lower_education_rich =  round(sum(lower_education["salary"]==">50K")*100/len(lower_education),1)
    ...
    highest_earning_country = (df.loc[df["salary"]==">50K", "native-country"].value_counts()*100/df["native-country"].value_counts()).idxmax()
    highest_earning_country_percentage = (df.loc[df["salary"]==">50K", "native-country"].value_counts()*100/df["native-country"].value_counts()).max().round(1)
